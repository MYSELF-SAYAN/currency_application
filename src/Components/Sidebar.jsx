...
export default function Sidebar() {
  ...
  return (
    <div className="Sidebar w-[200px] h-[100%] sm:w-[100%] sm:h-[100px] sm:relative sm:flex sm:justify-between bg-blue-950 fixed">
        <h1 className="SidebarTitle text-white text-[1.5rem] sm:text-[1.2rem] sm:mr-[200px] text-center justify-center sm:mt-7 sm:ml-4">
          CRYPTO <span>hub</span>
        </h1>
      <div className="SideHead sm:flex sm:justify-between sm:flex-row-reverse sm:p-7">
            <span className=" hidden sm:block">

        <MenuIcon className="text-white hidden sm:block" onClick={toggleNav} />
            </span>
      <ul
        className={`SidebarItemList sm:flex sm:flex-col pt-2 ${
          openNav ? "sm:block sm:bg-gray-400 sm:absolute sm:z-[1] " : "sm:hidden"
        } `}
        >
        <Link to="/">
